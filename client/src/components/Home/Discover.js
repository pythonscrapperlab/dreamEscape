...
const Discover = () => {
  ...
  return (
    <div
      name="discover"
      className="discover w-full h-full md:h-screen relative p-8"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4">
          {destinations.map((city) => (
            <Link
              ...
              key={city.id}
              className="images relative group max-w-sm rounded-md overflow-hidden opacity-80 hover:opacity-100 transition-all ease-in-out duration-300"
            >
